...
class pickaxe_rock extends \pocketmine\item\Pickaxe implements \customiesdevs\customies\item\ItemComponents{
	...
	public function __construct(ItemIdentifier $identifier, string $name){
		...
		$this->initComponent("pickaxe_rock", new CreativeInventoryInfo(CreativeInventoryInfo::CATEGORY_EQUIPMENT, CreativeInventoryInfo::GROUP_PICKAXE));
